...
import { editCategoryBannerCategoryDefault, updateCategoryBannerDefault} from '../../../../actions/categoryActions';
...
class EditBannerCategoryDefault extends Component {
    state = {
    ...
    componentDidMount() {
        this.props.editCategoryBannerCategoryDefault(this.props.match.params.id);
    }
    ...
    handlerSubmitCreate = () => {
        ...
        this.props.updateCategoryBannerDefault(this.props.match.params.id, data, this.props.history);
    }
    handleChangePromo = ()=>{
...
EditBannerCategoryDefault.propType = {
    classes: PropTypes.object.isRequired,
    errors: PropTypes.object.isRequired,
    categories: PropTypes.object.isRequired,
    editCategoryBannerCategoryDefault:PropTypes.func.isRequired,
    updateCategoryBannerDefault: PropTypes.func.isRequired,
}
...
export default compose(connect(mapStateToProps, { editCategoryBannerCategoryDefault, updateCategoryBannerDefault} ), withStyles(styles))(withRouter(EditBannerCategoryDefault));

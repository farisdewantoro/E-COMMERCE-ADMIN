...
import { editCategoryBannerCategoryTag, updateCategoryBannerTag} from '../../../../actions/categoryActions';
...
class EditBannerCategoryTag extends Component {
    state = {
    ...
    componentDidMount() {
        this.props.editCategoryBannerCategoryTag(this.props.match.params.id);
    }
    ...
    handlerSubmitCreate = () => {
        ...
        this.props.updateCategoryBannerTag(this.props.match.params.id, data, this.props.history);
    }
    handleChangePromo = ()=>{
...
EditBannerCategoryTag.propType = {
    classes: PropTypes.object.isRequired,
    errors: PropTypes.object.isRequired,
    categories: PropTypes.object.isRequired,
    editCategoryBannerCategoryTag:PropTypes.func.isRequired,
    updateCategoryBannerTag: PropTypes.func.isRequired,
}
...
export default compose(connect(mapStateToProps, { editCategoryBannerCategoryTag, updateCategoryBannerTag} ), withStyles(styles))(withRouter(EditBannerCategoryTag));

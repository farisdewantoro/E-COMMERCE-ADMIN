...
import { editCategoryBannerCategory, updateCategoryBannerCategory} from '../../../../actions/categoryActions';
...
class EditBannerCategory extends Component {
    state = {
    ...
    componentDidMount() {
        this.props.editCategoryBannerCategory(this.props.match.params.id);
    }
    ...
    handlerSubmitCreate = () => {
        ...
        this.props.updateCategoryBannerCategory(this.props.match.params.id, data, this.props.history);
    }
    handleChangePromo = ()=>{
    ...
    render() {
        ...
        const { imageSelectedDesktop, 
            openStateMedia,
            imageSelectedMobile, imageSelectedDesktopPromo, imageSelectedMobilePromo, category } = this.state;
...
EditBannerCategory.propType = {
    classes: PropTypes.object.isRequired,
    errors: PropTypes.object.isRequired,
    categories: PropTypes.object.isRequired,
    editCategoryBannerCategory:PropTypes.func.isRequired,
    updateCategoryBannerCategory: PropTypes.func.isRequired,
}
...
export default compose(connect(mapStateToProps, { editCategoryBannerCategory, updateCategoryBannerCategory} ), withStyles(styles))(withRouter(EditBannerCategory));

...
import {getAllCategoryBannerCategory} from '../../../../actions/categoryActions';
        ...
        return (
            <div>
                <Grid container direction="column" spacing={16}>
                    ...
                    <Grid item md={12}>
                        <Card>
                            <CardHeader title="Banner Category"/>
                            <Divider/>
                            <CardContent>
                                <Grid container direction="column" spacing={16}>

                                    {categories
                                        .category instanceof Array && categories
                                        .category
                                        .map((c, i) => {
                                            return (
                                            <ExpansionPanel
                                                ...
                                                <ExpansionPanelDetails>
                                                        <Grid container direction="row" spacing={16}>
                                                            ...
                                                            <Grid item xs={12}>
                                                                <Card>
                                                                    ...
                                                                    <Divider />
                                                                    <CardContent>
                                                                        {categories.image_desktop.filter(id=>id.category_id === c.id).length === 0 && (
                                                                            <Typography
                                                                                style={{
                                                                                    textAlign: 'center',
                                                                                    fontWeight: "bold"
                                                                        ...
                                                                        {categories.image_desktop.filter(id => id.category_id === c.id).map(cid=>{
                                                                            return(
                                                                                <div key={cid.id}>
                                                            ...
                                                            <Grid item md={12}>
                                                                <Card>
                                                                    ...
                                                                    <Divider />
                                                                    <CardContent>
                                                                        {categories.image_mobile.filter(id => id.category_id === c.id).length === 0 && (
                                                                            <Typography
                                                                                style={{
                                                                                    textAlign: 'center',
                                                                                    fontWeight: "bold"
                                                                        ...
                                                                        {categories.image_mobile.filter(id => id.category_id === c.id).map(cid => {
                                                                            return (
                                                                                <div key={cid.id}>
                                                                                    <img src={cid.link} alt={cid.alt} style={{ maxWidth: "100%",maxHeight:"500px" }} />
                                                                                    <Typography>
                                                            ...
                                                            {categories.image_desktop_promo.filter(id => id.category_id === c.id).length > 0 && (
                                                            <Grid item xs={12}>
                                                                <Card>
                                                                    <CardHeader subheader='DESKTOP BANNER PROMO' />
                                                                    <Divider />
                                                                    <CardContent>
                                                                            {categories.image_desktop_promo.filter(id => id.category_id === c.id).map(cid => {
                                                                                return (
                                                                                    <div key={cid.id}>
                                                                                        <img src={cid.link} alt={cid.alt} style={{ maxWidth: "100%",maxHeight:"500px" }} />
                                                                                        <Typography>
                                                            ...
                                                            {categories.image_mobile_promo.filter(id => id.category_id === c.id).length > 0 && (
                                                            ...
                                                            <Grid item md={12}>
                                                                <Card>
                                                                    ...
                                                                    <Divider />
                                                                    <CardContent>
                                                                            {categories.image_mobile_promo.filter(id => id.category_id === c.id).map(cid => {
                                                                                return (
                                                                                    <div key={cid.id}>
                                                                                        <img src={cid.link} alt={cid.alt} style={{ maxWidth: "100%",maxHeight:"500px" }} />
                                                                                        <Typography>
                                                    ...
                                                    <ExpansionPanelActions>
                                                        ...
                                                        <Button size="small" color="primary" component={Link} to={`/category/banner-category/edit/${c.id}`}>
                                                            EDIT
                                                        </Button>
                                                    </ExpansionPanelActions>
                                         </ExpansionPanel> 
...
CategoryBanner.propType = {
    classes: PropTypes.object.isRequired,
    categories: PropTypes.object.isRequired,
    notifications: PropTypes.object.isRequired,
    getAllCategoryBannerCategory: PropTypes.func.isRequired
}

const mapStateToProps = (state) => ({categories: state.categories, notifications: state.notifications})

export default compose(connect(mapStateToProps, {getAllCategoryBannerCategory}), withStyles(styles))(CategoryBanner);
